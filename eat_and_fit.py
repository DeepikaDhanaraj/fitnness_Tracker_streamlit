...
if not st.session_state.page1['is_first_load']:
    ...
    if body == 0:
        ...
        with engine.connect() as conn:
            ...
            #sc_result = conn.execute("SELECT * FROM StandardCalories WHERE Stage = :stage AND Body = :body AND Sex = :sex",{'stage': st.session_state.page1['stage'], 'body': body, 'sex': st.session_state.page1['sex']} ).fetchone()
            query = text("SELECT * FROM StandardCalories WHERE Stage = :stage AND Body = :body AND Sex = :sex")
            sc_result = conn.execute(query, {'stage': st.session_state.page1['stage'], 'body': body,
                                             'sex': st.session_state.page1['sex']}).fetchone()
            standard_calories = StandardCalories(*sc_result)

            # Get low carb diet  
            #lc_result = conn.execute("SELECT * FROM LowCarb WHERE Calories = :calories", {'calories': standard_calories.low_carb}).fetchone()
            query_lc = text("SELECT * FROM LowCarb WHERE Calories = :calories")
            lc_result = conn.execute(query_lc, {'calories': standard_calories.low_carb}).fetchone()
           ...
           # lcb1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id"{'id': low_carb_breakfast_detail.id1}, ).fetchone()
            query_lcb1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcb1_result = conn.execute(query_lcb1, {'id': low_carb_breakfast_detail.id1}).fetchone()
            #lcb2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': low_carb_breakfast_detail.id2}, ).fetchone()
            query_lcb2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcb2_result = conn.execute(query_lcb2, {'id': low_carb_breakfast_detail.id2}).fetchone()
            #lcl1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': low_carb_lunch_detail.id1}, ).fetchone()
            query_lcl1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcl1_result = conn.execute(query_lcl1, {'id': low_carb_lunch_detail.id1}).fetchone()
            #lcl2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': low_carb_lunch_detail.id2}, ).fetchone()
            query_lcl2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcl2_result = conn.execute(query_lcl2, {'id': low_carb_lunch_detail.id2}).fetchone()
            #lcd1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': low_carb_dinner_detail.id1}, ).fetchone()
            query_lcd1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcd1_result = conn.execute(query_lcd1, {'id': low_carb_dinner_detail.id1}).fetchone()
            #lcd2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id", {'id': low_carb_dinner_detail.id2}, ).fetchone()
            query_lcd2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcd2_result = conn.execute(query_lcd2, {'id': low_carb_dinner_detail.id2}).fetchone()
            ...
            #lc_result = conn.execute("SELECT * FROM ModerateCarb WHERE Calories = :calories", {'calories': standard_calories.moderate_carb}, ).fetchone()
            query_lc = text("SELECT * FROM ModerateCarb WHERE Calories = :calories")
            lc_result = conn.execute(query_lc, {'calories': standard_calories.moderate_carb}).fetchone()
            ...
            #lcb1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': moderate_carb_breakfast_detail.id1}, ).fetchone()
            query_lcb1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcb1_result = conn.execute(query_lcb1, {'id': moderate_carb_breakfast_detail.id1}).fetchone()
            #lcb2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': moderate_carb_breakfast_detail.id2}, ).fetchone()
            query_lcb2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcb2_result = conn.execute(query_lcb2, {'id': moderate_carb_breakfast_detail.id2}).fetchone()
            #lcl1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': moderate_carb_lunch_detail.id1}, ).fetchone()
            query_lcl1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcl1_result = conn.execute(query_lcl1, {'id': moderate_carb_lunch_detail.id1}).fetchone()
            #lcl2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': moderate_carb_lunch_detail.id2}, ).fetchone()
            query_lcl2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcl2_result = conn.execute(query_lcl2, {'id': moderate_carb_lunch_detail.id2}).fetchone()
            #lcd1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': moderate_carb_dinner_detail.id1}, ).fetchone()
            query_lcd1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcd1_result = conn.execute(query_lcd1, {'id': moderate_carb_dinner_detail.id1}).fetchone()
            #lcd2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': moderate_carb_dinner_detail.id2}, ).fetchone()
            query_lcd2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcd2_result = conn.execute(query_lcd2, {'id': moderate_carb_dinner_detail.id2}).fetchone()
            ...
            # Get high carb diet
            #hc_result = conn.execute("SELECT * FROM HighCarb WHERE Calories = :calories", {'calories': standard_calories.high_carb}, ).fetchone()
            query_hc = text("SELECT * FROM HighCarb WHERE Calories = :calories")
            hc_result = conn.execute(query_hc, {'calories': standard_calories.high_carb}).fetchone()
            ...
            #lcb1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': high_carb_breakfast_detail.id1}, ).fetchone()
            query_lcb1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcb1_result = conn.execute(query_lcb1, {'id': high_carb_breakfast_detail.id1}).fetchone()
            #lcb2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id", {'id': high_carb_breakfast_detail.id2}, ).fetchone()
            query_lcb2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcb2_result = conn.execute(query_lcb2, {'id': high_carb_breakfast_detail.id2}).fetchone()
            #lcl1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': high_carb_lunch_detail.id1}, ).fetchone()
            query_lcl1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcl1_result = conn.execute(query_lcl1, {'id': high_carb_lunch_detail.id1}).fetchone()
            #lcl2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id", {'id': high_carb_lunch_detail.id2}, ).fetchone()
            query_lcl2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcl2_result = conn.execute(query_lcl2, {'id': high_carb_lunch_detail.id2}).fetchone()
            #lcd1_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': high_carb_dinner_detail.id1}, ).fetchone()

            query_lcd1 = text("SELECT * FROM Dish WHERE Id = :id")
            lcd1_result = conn.execute(query_lcd1, {'id': high_carb_dinner_detail.id1}).fetchone()
            #lcd2_result = conn.execute("SELECT * FROM Dish WHERE Id = :id",{'id': high_carb_dinner_detail.id2}, ).fetchone()
            query_lcd2 = text("SELECT * FROM Dish WHERE Id = :id")
            lcd2_result = conn.execute(query_lcd2, {'id': high_carb_dinner_detail.id2}).fetchone()
        ...
        # Cardio
        with engine.connect() as conn:
            #cardio_result = conn.execute("SELECT * FROM Cardio WHERE Stage = :stage and Body = :body and Sex = :sex;",{'stage': st.session_state.page1['stage'], 'body': body, 'sex': st.session_state.page1['sex']},).fetchone()
            query_cardio = text("SELECT * FROM Cardio WHERE Stage = :stage AND Body = :body AND Sex = :sex")
            cardio_result = conn.execute(query_cardio, {'stage': st.session_state.page1['stage'], 'body': body,
                                                        'sex': st.session_state.page1['sex']}).fetchone()
        ...
        with col1:
            with engine.connect() as conn:
                ...
                query_lower_gym = text("SELECT * FROM Gym WHERE Day = 'lower';")
                lower_gym_result = conn.execute(query_lower_gym).fetchall()
            ...
            for lg_result in lower_gym_result:
                ...
                with engine.connect() as conn:
                    ...
                    query_exercise = text("SELECT * FROM Exercise WHERE Id = :id")
                    exercise_result = conn.execute(query_exercise, {'id': lg.exercise}).fetchone()
        ...
        with col2:
            with engine.connect() as conn:
                ...
                query_upper_gym = text("SELECT * FROM Gym WHERE Day = :day")
                upper_gym_result = conn.execute(query_upper_gym, {'day': 'upper'}).fetchall()
            upper_gym = []
            for ug_result in upper_gym_result:
                ...
                with engine.connect() as conn:
                    ...
                    query_exercise = text("SELECT * FROM Exercise WHERE Id = :id")
                    exercise_result = conn.execute(query_exercise, {'id': ug.exercise}).fetchone()
                    exercise = Exercise(*exercise_result)
